...
# Figure S10: mutational signatures analysis comparisons

This document produces Figure S10 from the lungNENomics manuscript, which displays the mutational signatures of different types of variants compared across molecular groups and histological types. It also produces the data presented in Table S21.
...
ggsave( gg_SBS/gg_ID/gg_CN/gg_SV + plot_layout(widths = c(1, 4)) , filename = "FigS11A_mutational_signatures_median_dotplots.svg",height = 2.5*4,width=3)
```
...
## Fig. S11C: Mutations as a function of age
```{r}
...
## Extended data figure E: Drivers - per signatures
